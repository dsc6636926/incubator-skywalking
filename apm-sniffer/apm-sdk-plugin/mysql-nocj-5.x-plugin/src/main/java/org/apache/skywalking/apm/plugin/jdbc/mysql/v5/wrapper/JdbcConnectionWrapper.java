...
public class JdbcConnectionWrapper implements MySQLConnection, EnhancedInstance {
    ...
    @Override
    public void createNewIO(boolean b) throws SQLException {
        delegate.createNewIO(b);
    }

    @Override
    public void dumpTestcaseQuery(String s) {
    ...
    @Override
    public ResultSetInternalMethods execSQL(StatementImpl statement, String s, int i, Buffer buffer, int i1, int i2, boolean b, String s1, Field[] fields) throws SQLException {
        return delegate.execSQL(statement, s, i, buffer, i1, i2, b, s1, fields);
    }

    @Override
    public ResultSetInternalMethods execSQL(StatementImpl statement, String s, int i, Buffer buffer, int i1, int i2, boolean b, String s1, Field[] fields, boolean b1) throws SQLException {
        return delegate.execSQL(statement, s, i, buffer, i1, i2, b, s1, fields, b1);
    }

    @Override
    public String extractSqlFromPacket(String s, Buffer buffer, int i) throws SQLException {
        return delegate.extractSqlFromPacket(s, buffer, i);
    }

    @Override
    public StringBuilder generateConnectionCommentBlock(StringBuilder stringBuilder) {
    ...
    @Override
    public SingleByteCharsetConverter getCharsetConverter(String s) throws SQLException {
    ...
    @Override
    public int getMaxBytesPerChar(String s) throws SQLException {
        return delegate.getMaxBytesPerChar(s);
    }

    @Override
    public int getMaxBytesPerChar(Integer integer, String s) throws SQLException {
    ...
    @Override
    public String getServerVariable(String s) {
