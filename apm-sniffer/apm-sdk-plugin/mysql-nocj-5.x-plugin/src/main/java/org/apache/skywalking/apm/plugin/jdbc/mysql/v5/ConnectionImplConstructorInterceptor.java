...
public class ConnectionImplConstructorInterceptor implements InstanceConstructorInterceptor {
    private static final ILog logger = LogManager.getLogger(ConnectionImplConstructorInterceptor.class);
    @Override
    public void onConstruct(EnhancedInstance objInst, Object[] allArguments) {
        objInst.setSkyWalkingDynamicField(URLParser.parser(allArguments[4].toString()));
    }
}
